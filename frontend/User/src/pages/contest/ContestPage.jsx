...
const ContestPage = () => {
    ...
    return (
        <div className={`flex flex-col-reverse md:flex-row mt-16 justify-around ps-6 md:ps-16 bg-gray-950 mb-4`}>
            ...
            <div className={`${attribute} max-md:mr-[5%] max-md:mt-4 md:w-fit text-center mt-4`}>
                <Timer />
            </div>
