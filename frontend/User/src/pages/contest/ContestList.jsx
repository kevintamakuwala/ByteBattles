...
const ContestList = () => {
    ...
    const generateContests = (count, property) => {
        ...
        for (let i = 0; i < count; i++) {
            if (i % 2 === 0) {
                contests.push(<Contest key={i} value={property} backgroundColor="bg-gray-900" />);
            }
            else {
                contests.push(<Contest key={i} value={property} backgroundColor="bg-gray-800" />);
            }
    ...
    useEffect(() => {
        ...
        fetchData(liveContestCount, liveOffset, setLivePageCount, setLivePostData, liveContests);
        fetchData(upContestCount, upOffset, setUpPageCount, setUpComingPostData, upContests);
        fetchData(pastContestCount, pastOffset, setPastPageCount, setPastPostData, pastContests);
