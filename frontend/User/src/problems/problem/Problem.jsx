...
const Problem = ({value}) => {
  ...
  return (
    <div className='problem__container flex flex-col min-[466px]:flex-row min-[505px]:text-lg text-base md:flex-row text-center justify-between items-center rounded-lg px-3 md:pe-5 lg:px-5 py-5 md:py-3 font-sans bg-slate-900 mb-4 text-white md:items-center md:text-center md:align-middle md:justify-between md:min-w-840px md:max-w-999px md:text-lg  lg:text-xl '>
      ...
      <div className={`problem-difficulty font-sans pt-1 md:pt-0 md:pl-3 ${value}`}>
        Easy
      </div>
